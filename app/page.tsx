    ...
    <div className="w-full min-h-screen flex items-center justify-center flex-col">
      ...
      <div className="relative">
        <div className="w-fit text-center relative space-y-10 z-[100]">
          <div className="text-8xl z-[100] font-semibold bg-gradient-to-r from-rose-600 via-indigo-600 to-slate-500 text-transparent bg-clip-text">
            Next-Auth
          </div>
          <p className="text-center z-[100] font-medium text-3xl text-transparent bg-gradient-to-r from-slate-300 via-indigo-400 to-purple-400 bg-clip-text">
